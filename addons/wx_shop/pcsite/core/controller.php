...
class Controller
{
	public function template($name = '')
	{
		...
		$compile = IA_ROOT . '/data/tpl/web/wx_shop_web/' . ES_STYLE . '/' . $name . '.tpl.php';
	...
	{
		global $_W;
		$basicset = pdo_fetch('select * from ' . tablename('wx_shop_system_site') . ' where `type`=:type', array(':type' => 'set'));
