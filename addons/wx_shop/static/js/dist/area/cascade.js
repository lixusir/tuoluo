...
function cascdeInit(na,os,v1,v2,v3,v4,v5) {
    ...
    //打开xlmdocm文档
    if (new_area == 1) {
        var xmlfile = '../addons/wx_shop/static/js/dist/area/AreaNew.xml?v=4';
    } else {
        var xmlfile = '../addons/wx_shop/static/js/dist/area/Area.xml?v=4';
    }
...
function selectcounty(v3,v4,v5) {
    ...
    if (new_area == 1 && open_street == 1) {
        ...
        if (city_code) {
            ...
            var xmlUrl = '../addons/wx_shop/static/js/dist/area/list/'+left+'/'+city_code+'.xml';
