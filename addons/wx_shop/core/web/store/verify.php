...
class Verify_WxShopPage extends ComWebPage
{
	...
	public function verifygoods() 
	{
		...
		{
			$store = pdo_fetch('select * from ' . tablename('wx_shop_store') . ' where id=:id and uniacid=:uniacid limit 1', array(':id' => $verifygood['storeid'], ':uniacid' => $_W['uniacid']));
		}
		include $this->template();
	}
	public function log() 
