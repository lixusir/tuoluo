...
class Log_WxShopPage extends ComWebPage 
{
	...
	public function main() 
	{
		...
		if (!(empty($couponid))) 
		{
			$coupon = pdo_fetch('select * from ' . tablename('wx_shop_coupon') . ' where id=:id and uniacid=:uniacid and merchid=0 limit 1', array(':id' => $couponid, ':uniacid' => $_W['uniacid']));
