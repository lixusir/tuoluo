...
class Changepwd_WxShopPage extends MobileLoginPage 
{
	protected $member;
	...
	public function main() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			pdo_update('wx_shop_member', array('mobile' => $mobile, 'pwd' => md5($pwd . $salt), 'salt' => $salt, 'mobileverify' => 1), array('id' => $this->member['id'], 'uniacid' => $_W['uniacid']));
			unset($_SESSION[$key]);
			show_json(1);
		}
