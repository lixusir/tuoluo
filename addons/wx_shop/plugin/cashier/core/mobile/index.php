...
class Index_WxShopPage extends CashierMobilePage
{
	...
	public function __construct() 
	{
		global $_W;
		parent::__construct();
		$this->operatorid = (int) pdo_fetchcolumn('SELECT id FROM ' . tablename('wx_shop_cashier_operator') . ' WHERE manageopenid=:manageopenid AND uniacid=:uniacid LIMIT 1', array(':manageopenid' => $_W['openid'], ':uniacid' => $_W['uniacid']));
