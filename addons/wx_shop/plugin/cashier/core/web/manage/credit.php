...
class Credit_WxShopPage extends CashierWebPage
{
	...
	public function recharge_submit() 
	{
		...
		pdo_delete('wx_shop_cashier_log', array('cashierid' => $_W['cashierid'], 'status' => 0, 'uniacid' => $_W['uniacid']));
		pdo_insert('wx_shop_cashier_log', $log);
		$logid = pdo_insertid();
		if (!($logid)) 
		{
