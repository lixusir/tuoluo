...
class Record_WxShopPage extends PluginWebPage 
{
	...
	public function ajaxorder() 
	{
		global $_W;
		global $_GPC;
		$daifahuo = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('wx_shop_order') . ' WHERE ordersn LIKE \'DH%\' AND uniacid = :uniacid AND status = 1', array(':uniacid' => $_W['uniacid']));
		$weifukuan = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('wx_shop_order') . ' WHERE ordersn LIKE \'DH%\' AND uniacid = :uniacid AND status = 0', array(':uniacid' => $_W['uniacid']));
		$daishouhuo = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('wx_shop_order') . ' WHERE ordersn LIKE \'DH%\' AND uniacid = :uniacid AND status = 2', array(':uniacid' => $_W['uniacid']));
		$yiwancheng = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('wx_shop_order') . ' WHERE ordersn LIKE \'DH%\' AND uniacid = :uniacid AND status = 3', array(':uniacid' => $_W['uniacid']));
		$yiguanbi = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('wx_shop_order') . ' WHERE ordersn LIKE \'DH%\' AND uniacid = :uniacid AND status = -1', array(':uniacid' => $_W['uniacid']));
		$all = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('wx_shop_order') . ' WHERE ordersn LIKE \'DH%\' AND uniacid = :uniacid', array(':uniacid' => $_W['uniacid']));
