...
class Index_WxShopPage extends PluginMobileLoginPage
{
	...
	public function calculate() 
	{
		...
		foreach ($goods_tmp as $gk => $gv ) 
		{
			...
			pdo_insert('wx_shop_exchange_cart', array('uniacid' => $_W['uniacid'], 'openid' => $_W['openid'], 'goodsid' => $price['id'], 'marketprice' => $price['marketprice'], 'optionid' => 0, 'merchid' => $price['merchid'], 'title' => $price['title'], 'groupid' => $exchange['groupid'], 'serial' => $exchange['serial']));
			if ($price == false) 
			{
				continue;
			}
