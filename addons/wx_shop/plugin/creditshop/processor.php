...
require WX_SHOP2_INC . 'plugin/plugin_processor.php';
class CreditshopProcessor extends PluginProcessor 
{
	...
	public function respond($obj = NULL) 
	{
		...
		if (($msgtype == 'text') || ($event == 'click')) 
		{
			...
			{
				$log = pdo_fetch('select * from ' . tablename('wx_shop_creditshop_log') . ' where eno=:eno and uniacid=:uniacid  limit 1', array(':eno' => $content, ':uniacid' => $_W['uniacid']));
				if (empty($log)) 
				{
