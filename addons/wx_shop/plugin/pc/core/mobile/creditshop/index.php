...
class Index_WxShopPage extends PcMobilePage
{
	public function main() 
	{
		...
		$advs = pdo_fetchall('select id,advname,link,thumb from ' . tablename('wx_shop_creditshop_adv') . ' where uniacid=:uniacid and enabled=1 order by displayorder desc', array(':uniacid' => $uniacid));
