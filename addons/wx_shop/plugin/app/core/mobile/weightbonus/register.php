...
class Register_WxShopPage
{
	...
	public function main()
	{
        ...
        if (($member['isweight'] == 1) && ($member['weightstatus'] == 1)) {
			//如果为代理，跳转到代理分红页面
            show_json(0, mobileUrl('weightbonus'));
        }
        ...
        show_json(1,array('set'=>$set,'apply_set'=>$apply_set,'shopname' => $_W['shopset']['shop']['name'], 'member'=>$member,'template_flag'=>$template_flag));
	}
