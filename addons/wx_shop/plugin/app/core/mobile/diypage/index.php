...
class Index_WxShopPage extends AppMobilePage
{
	public function main()
	{
		...
		if (is_array($page['data']['page']) && !(empty($page['data']['page']['diyadv']))) {
			$startadvitem = pdo_fetch('SELECT * FROM ' . tablename('wx_shop_wxapp_startadv') . ' WHERE id=:id AND uniacid=:uniacid', array(':id' => intval($page['data']['page']['diyadv']), ':uniacid' => $_W['uniacid']));
