...
class Withdraw_WxShopPage extends AppMobilePage
{
	public function main()
	{
		...
		if ($set['withdrawcashweixin'] == 1) {
            $type_array[] = array('type' => 1, 'title' => '提现到微信');
		}
	...
	public function getLastApply($openid, $applytype = -1)
	{
		...
		$sql = 'select applytype,alipay,bankname,bankcard,realname from ' . tablename('wx_shop_member_log') . ' where openid=:openid and uniacid=:uniacid';
