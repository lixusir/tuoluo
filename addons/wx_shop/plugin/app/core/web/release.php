...
class Release_WxShopPage extends PluginWebPage
{
	...
	public function audit()
	{
		...
		if ($action == 'upload') {
			...
			$request = ihttp_post(WX_SHOP_AUTH_WXAPP . 'index/index/submitCode2.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'], array('tabBar' => $tabBar));
		}
		else {
			$request = ihttp_post(WX_SHOP_AUTH_WXAPP . 'index/index/auditCode.html?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid'], array());
		}
	...
	public function auth()
	{
		...
		header('Location:' . WX_SHOP_AUTH_WXAPP . 'index/index/xcxAuth?site_id=' . SITE_ID . '&uniacid=' . $_W['uniacid']);
	}
