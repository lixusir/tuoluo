define(['./jquery.event.ue.js', './jquery.udraggable.js'], function () {
    ...
    modal.defaultlist = [
        {
            tempid: 'default1',
            title: '模板1',
            thumb: '../addons/wx_shop/plugin/app/static/images/poster/thumb_01.png',
            bgimg: '../addons/wx_shop/plugin/app/static/images/poster/bg_01.png',
            psdurl: 'addons/wx_shop/plugin/app/static/others/template_01.psd',
            items: [
                {
                    type: 'qrcode',
                    size: 'big',
        ...
        },
        {
            tempid: 'default2',
            title: '模板2',
            thumb: '../addons/wx_shop/plugin/app/static/images/poster/thumb_02.png',
            bgimg: '../addons/wx_shop/plugin/app/static/images/poster/bg_02.png?v=2',
            psdurl: 'addons/wx_shop/plugin/app/static/others/template_02.psd',
            items: [
                {
                    type: 'qrcode',
                    size: 'big',
        ...
        },
        {
            tempid: 'default3',
            title: '模板3',
            thumb: '../addons/wx_shop/plugin/app/static/images/poster/thumb_03.png',
            bgimg: '../addons/wx_shop/plugin/app/static/images/poster/bg_03.png?v=2',
            psdurl: 'addons/wx_shop/plugin/app/static/others/template_03.psd',
            items: [
                {
                    type: 'qrcode',
                    size: 'small',
    ...
    modal.initTpl = function () {
        tpl.helper("imgsrc", function (src) {
            ...
            if (src.indexOf('http://') == 0 || src.indexOf('https://') == 0 || src.indexOf('../addons/wx_shop/') == 0) {
                return src
