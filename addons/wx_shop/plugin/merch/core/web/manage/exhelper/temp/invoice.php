...
class Invoice_WxShopPage extends MerchWebPage
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			{
				pdo_update('wx_shop_exhelper_express', array('isdefault' => 0), array('type' => 2, 'uniacid' => $_W['uniacid'], 'merchid' => $merchid));
				pdo_update('wx_shop_exhelper_express', array('isdefault' => 1), array('type' => 2, 'id' => $id, 'merchid' => $merchid));
			}
