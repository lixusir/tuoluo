...
class Index_WxShopPage extends MerchWebPage
{
	...
	public function shop() 
	{
		global $_W;
		global $_GPC;
		$item = pdo_fetch('select * from ' . tablename('wx_shop_merch_user') . ' where id=:id and uniacid=:uniacid limit 1', array(':id' => $_W['uniaccount']['merchid'], ':uniacid' => $_W['uniacid']));
		...
		if ($_W['ispost']) 
		{
			...
			pdo_update('wx_shop_merch_user', $data, array('id' => $_W['uniaccount']['merchid']));
			show_json(1);
		}
