...
class Index_WxShopPage extends MerchWebPage
{
	...
	public function ajax() 
	{
		...
		$goods_totals = pdo_fetchcolumn('SELECT COUNT(1) FROM ' . tablename('wx_shop_goods') . ' WHERE uniacid = :uniacid and merchid = :merchid and status=1 and deleted=0 and total<=0 and total<>-1  ', $paras);
