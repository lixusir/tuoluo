...
class Merch_WxShopPage extends PluginWebPage
{
	...
	public function ajax_user_data() 
	{
		...
		$merch = pdo_fetch('select * from ' . tablename('wx_shop_merch_user') . ' where id = :id', array(':id' => $merchid));
