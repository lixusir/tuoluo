...
class Invoice_WxShopPage extends PluginWebPage 
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			if (!(empty($id))) 
			{
				pdo_update('wx_shop_exhelper_express', $data, array('id' => $id, 'merchid' => 0));
			...
			{
				pdo_update('wx_shop_exhelper_express', array('isdefault' => 0), array('type' => 2, 'uniacid' => $_W['uniacid'], 'merchid' => 0));
				pdo_update('wx_shop_exhelper_express', array('isdefault' => 1), array('type' => 2, 'id' => $id, 'merchid' => 0));
			}
