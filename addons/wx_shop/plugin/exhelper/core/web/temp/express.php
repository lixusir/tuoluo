...
class Express_WxShopPage extends PluginWebPage
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			{
				pdo_update('wx_shop_exhelper_express', array('isdefault' => 0), array('type' => 1, 'uniacid' => $_W['uniacid'], 'merchid' => 0));
				pdo_update('wx_shop_exhelper_express', array('isdefault' => 1), array('type' => 1, 'id' => $id, 'merchid' => 0));
			}
