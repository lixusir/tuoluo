...
class Refund_WxShopPage extends MmanageMobilePage
{
	...
	protected function submit()
	{
		...
		if ($refundstatus == 0) {
			...
			if (0 < $item['parentid']) {
				$parent_item = pdo_fetch('SELECT id,ordersn,ordersn2,price FROM ' . tablename('wx_shop_order') . ' WHERE id = :id and uniacid=:uniacid Limit 1', array(':id' => $item['parentid'], ':uniacid' => $_W['uniacid']));
