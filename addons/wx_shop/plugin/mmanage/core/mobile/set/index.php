...
class Index_WxShopPage extends MmanageMobilePage
{
	public function main()
	{
		global $_W;
		global $_GPC;
		$roleuser = pdo_fetch('SELECT id, uid, username, status, openid, realname, mobile FROM' . tablename('wx_shop_perm_user') . 'WHERE uid=:uid AND uniacid=:uniacid', array(':uid' => $_W['uid'], ':uniacid' => $_W['uniacid']));
