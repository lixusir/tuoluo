...
class Template_WxShopPage extends PluginWebPage
{
	...
	public function check()
	{
		...
		if ($_W['ispost']) {
			...
			$member = pdo_fetch('select *  from ' . tablename('wx_shop_member') . ' where openid=:openid and uniacid = :uniacid ', array(':openid' => $check_openid, ':uniacid' => $_W['uniacid']));
