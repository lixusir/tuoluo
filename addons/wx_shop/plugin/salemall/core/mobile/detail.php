...
class Detail_WxShopPage extends PluginMobileLoginPage
{
	...
	public function pay($a = array(), $b = array()) 
	{
		...
		if ($needpay) 
		{
			...
			pdo_update('wx_shop_creditshop_log', array('paytype' => ($useweixin ? 1 : 0)), array('id' => $logid));
			if ($useweixin) 
			{
	...
	public function lottery() 
	{
		...
		pdo_update('wx_shop_creditshop_goods', array('joins' => $goods['joins'] + 1), array('id' => $id));
