...
class Taobaocsv_WxShopPage extends PluginWebPage
{
	public function main()
	{
		...
		$uploadStart = '0';
		$uploadnum = '0';
		$excelurl = $_W['siteroot'] . 'addons/wx_shop/plugin/taobao/data/test.xlsx';
		$zipurl = $_W['siteroot'] . 'addons/wx_shop/plugin/taobao/data/test.zip';
