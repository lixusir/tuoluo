...
class GroupsProcessor extends PluginProcessor
{
	public function __construct()
	{
		...
		$this->sessionkey = WX_SHOP_PREFIX . 'gorder_wechat_verify_info';
		$this->codekey = WX_SHOP_PREFIX . 'gorder_wechat_verify_code';
	}
