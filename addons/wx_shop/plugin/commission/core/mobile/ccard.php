...
class Ccard_WxShopPage extends CommissionMobileLoginPage
{
	...
	public function get_list()
	{
		...
		$sql = 'select * from ' . tablename('wx_shop_ccard') . ' where status = 1 and uniacid=:uniacid and (agentid1 = :uid or agentid2 = :uid) order by id desc LIMIT ' . (($pindex - 1) * $psize) . ',' . $psize;
		$sql1 = 'select count(1) from ' . tablename('wx_shop_ccard') . ' where status = 1 and uniacid=:uniacid and (agentid1 = :uid or agentid2 = :uid)';
