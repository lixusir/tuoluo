...
class Board_WxShopPage extends SnsMobilePage
{
	...
	public function follow()
	{
		...
		$follow = pdo_fetch('select id from ' . tablename('wx_shop_sns_board_follow') . ' where bid=:bid and openid=:openid limit 1', array(':bid' => $bid, ':openid' => $_W['openid']));
