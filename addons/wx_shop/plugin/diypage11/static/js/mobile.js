define(['core', 'tpl'], function (core, tpl) {
    ...
    modal.initSwiper = function () {
        ...
        if($('[data-toggle="timer"]').length>0){
            require(['../addons/wx_shop/plugin/seckill/static/js/timer.js'],function(timerUtil){
                ...
                if (result.status == 1) {
                    ...
                    if (list) {
                        ...
                        $.each(list, function (id, merch) {
                            var thumb = merch.thumb ? merch.thumb : '../addons/wx_shop/plugin/diypage/static/images/default/logo.jpg';
                            var html = '';
