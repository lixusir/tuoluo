    ...
    modal.init = function (params) {
        ...
        if (!modal.menu) {
            modal.menu = {
                ...
                data: {
                    M0123456789101: {
                        imgurl: '../addons/wx_shop/plugin/diypage/static/images/default/menu-1.png',
                        linkurl: '',
                        iconclass: 'icon-home',
                        text: '商城首页'
                    },
                    M0123456789102: {
                        imgurl: '../addons/wx_shop/plugin/diypage/static/images/default/menu-2.png',
                        linkurl: '',
                        iconclass: 'icon-list',
                        text: '全部商品'
                    },
                    M0123456789103: {
                        imgurl: '../addons/wx_shop/plugin/diypage/static/images/default/menu-3.png',
                        linkurl: '',
                        iconclass: 'icon-group',
                        text: '分销中心'
                    },
                    M0123456789104: {
                        imgurl: '../addons/wx_shop/plugin/diypage/static/images/default/menu-4.png',
                        linkurl: '',
                        iconclass: 'icon-cart',
                        text: '购物车'
                    },
                    M0123456789105: {
                        imgurl: '../addons/wx_shop/plugin/diypage/static/images/default/menu-5.png',
                        linkurl: '',
