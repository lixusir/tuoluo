...
TPL;
	}else if(strcasecmp(ADDONS_URL,'http://v2.addons.HaiShengcms.com')==0) {
			$xsd = <<<TPL
<?xml version="1.0" encoding="utf-8"?>
<xs:schema xmlns='http://www.HaiShengcms.com' targetNamespace='http://www.HaiShengcms.com' xmlns:xs="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
	<xs:element name="entry">
		<xs:complexType>
			<xs:attribute name="title" type="xs:string" />
			<xs:attribute name="do" type="xs:string" />
